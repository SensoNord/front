            ...
            ><div className='space-y-8 text-left'>
                ...
                />
                    <div className="text-center pt-5">
                        <button className='w-3/5 bg-blue-500 hover:bg-blue-600 text-white tablet:text-2xl rounded-lg p-2 tablet:p-3 focus:outline-none' onClick={updatePassword}>Valider</button>
                    </div>
